  ...
  <v-container fluid class="content">
    ...
    <v-row>
      ...
      >
        <v-card
          class="mb-3"
          style="background-color: #25b7a1; border-radius: 50px"
        >
          <v-row no-gutters>
            <v-col cols="2" class="pa-3 d-flex align-center justify-center">
              <div
                ...
                :style="{
                  'background-image':
                    'url(' + getImageUrl(donation.source) + ')',
                }"
              ></div>
            </v-col>
...
<script>
  ...
  export default {
    data: () => ({
      ...
      filterOptions: ['ALL', 'REVOLUT', 'YOUTUBE'],
    }),
    setup() {
    ...
    computed: {
      ...
      filteredDonations() {
        ...
        if (this.filter === 'ALL') return this.sortedDonations;
